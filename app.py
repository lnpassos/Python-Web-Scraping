...
# SELECIONAR ESTADO
# CLICAR EM PESQUISAR
# ENTRAR EM TODOS PROCESSOS
# EXTRAIR OS CAMPOS NECESSÁRIOS
# EXTRAIR OS ULTIMOS MOVIMENTOS, DA PRIMEIRA PÁGINA APENAS
# SALVAR TUDO NO EXCEL, SEPARADO POR PROCESSOS

#############################################################
# CÓDIGO DESENVOLVIDO PARA ``WEB SCRAPING``, UTILIZADO DADOS PÚBLICOS DE DEMANDAS REAIS DE CLIENTES.
...
# Insere os dados e faz a pesquisa
campo_oab = driver.find_element(By.XPATH, '//input[@id="fPP:Decoration:numeroOAB"]')
campo_oab.send_keys(numero_oab)

dropdown_uf = driver.find_element(By.XPATH, '//select[@id="fPP:Decoration:estadoComboOAB"]')
opcoes_estado = Select(dropdown_uf)
